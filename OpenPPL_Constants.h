...
#ifndef INC_OPENPPL_CONSTANTS_H
#define INC_OPENPPL_CONSTANTS_H

const int kOpenPPL_ConstCardAce = 14;
const int kOpenPPL_ConstCardKing = 13;
/*
##f$OpenPPL_Fold##
##f$OpenPPL_Check##
...
##f$OpenPPL_True##					// no need for true and false
##f$OpenPPL_False##
*/

#endif INC_OPENPPL_CONSTANTS_H